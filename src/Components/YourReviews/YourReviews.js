...
class YourReviews extends React.Component {
  ...
  render() { 
    ...
    let yourreviews = this.props.YourReviews.map(
      (yourreview, index) => {  
        //console.log(item);
        return (
          <YourReview
    ...
    return (
      ...
      {this.props.isLoadingYourReviews? 
        ...
        <>
        <p style={{ textAlign: "center" }}>(Sorry, there have no reviews for you yet.)</p>
        
        </>
        :
        <>
        <p style={{ textAlign: "center" }}>Just tap on the review to reply!</p>
        <p></p>
         {yourreviews}
        </>
        }
